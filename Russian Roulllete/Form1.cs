...
namespace Russian_Roulllete
{
    public partial class Form1 : Form
    {
        ...
        private readonly load game;

        internal load GetGame()
        {
            return game;
        }
...
#pragma warning restore CS0162 // Unreachable code detected
            ...
            {
                GetGame().spin(); //Calling Spin function from Game Class
                Button_Load.Enabled = false;
            ...
            {
                GetGame().Load(); //Calling Load function from Game Class//
        ...
        private void btn_shout_Click1(object sender, EventArgs e)
        {
            Button_Load.Enabled = false;
            btn_spin.Enabled = false;
